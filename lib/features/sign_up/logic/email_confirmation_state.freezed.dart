...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EmailConfirmationState<T>);
}
...
@override
String toString() {
  return 'EmailConfirmationState<$T>()';
}
...
/// @nodoc
class $EmailConfirmationStateCopyWith<T,$Res>  {
$EmailConfirmationStateCopyWith(EmailConfirmationState<T> _, $Res Function(EmailConfirmationState<T>) __);
}


/// Adds pattern-matching-related methods to [EmailConfirmationState].
extension EmailConfirmationStatePatterns<T> on EmailConfirmationState<T> {
...
class _Initial<T> implements EmailConfirmationState<T> {
  const _Initial();
...
class Loading<T> implements EmailConfirmationState<T> {
  const Loading();
...
class Success<T> implements EmailConfirmationState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of EmailConfirmationState
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $EmailConfirmationStateCopyWith<T, $Res> {
...
class Error<T> implements EmailConfirmationState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $EmailConfirmationStateCopyWith<T, $Res> {
