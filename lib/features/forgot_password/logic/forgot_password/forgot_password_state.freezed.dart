...
class Loading<T> implements ForgotPasswordState<T> {
  const Loading();
...
class Success<T> implements ForgotPasswordState<T> {
...
@override
String toString() {
  return 'ForgotPasswordState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ForgotPasswordStateCopyWith<T, $Res> {
...
class Error<T> implements ForgotPasswordState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ForgotPasswordStateCopyWith<T, $Res> {
