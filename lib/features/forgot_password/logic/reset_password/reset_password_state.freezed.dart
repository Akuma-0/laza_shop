...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResetPasswordState<T>);
}
...
$ResetPasswordStateCopyWith(ResetPasswordState<T> _, $Res Function(ResetPasswordState<T>) __);
}
...
class _Initial<T> implements ResetPasswordState<T> {
  const _Initial();
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ResetPasswordStateCopyWith<T, $Res> {
...
class Error<T> implements ResetPasswordState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ResetPasswordStateCopyWith<T, $Res> {
